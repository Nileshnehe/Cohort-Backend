    ...
    return (
        <div className='chatwindow'>
            <div className='navbar'>
                <span>Nexara.Pro &nbsp; <i class="fa-solid fa-chevron-down"></i> </span>
